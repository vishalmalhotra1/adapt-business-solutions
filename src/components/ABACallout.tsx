...
const points = [
  'Professional Corporation (PC) setup for BCBA practitioners',
  ...
  'OAP funding flow, RBT payroll, and HST on therapy services',
  'Tax strategy to keep more of what you earn',
]

export default function ABACallout() {
  return (
    <section className="py-20" style={{ background: 'linear-gradient(135deg, #0d2d3a 0%, #0d1b2a 60%)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">

          {/* Left: Text */}
          <div>
            <span className="inline-block bg-teal-500/20 text-teal-300 text-xs font-bold px-3 py-1.5 tracking-widest uppercase mb-5">
              Specialty Practice
            </span>
            ...
            <p className="text-navy-100 text-lg leading-relaxed mb-8">
              Most CPAs don&apos;t know CPBAO from CRA. We specialize in behavior analysts, BCBAs, RBTs, and ABA therapy practice owners across Canada — handling the complex tax and accounting issues general CPAs miss.
            </p>
          ...
          <div className="bg-white/5 border border-white/10 p-8">
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              <p className="text-navy-100 text-xs">
                Whether you&apos;re a solo BCBA contractor, running a multi-therapist practice, or anywhere in between — we&apos;ve incorporated ABA businesses, handled OAP funding payroll, and optimized tax strategy for behaviour analysts across Ontario and Canada.
              </p>
            </div>
          </div>
