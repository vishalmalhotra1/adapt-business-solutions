...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://adaptbusinesssolutions.com/locations/amaranth' },
}

const services = [
  { label: 'Tax Preparation', href: '/services/tax-preparation', desc: 'T1 personal and T2 corporate tax returns for Amaranth Township individuals and businesses.' },
  { label: 'Bookkeeping & Compilations', href: '/services/bookkeeping-compilations', desc: 'Monthly bookkeeping, bank reconciliations, and compiled financial statements.' },
  { label: 'Business Consulting', href: '/services/business-consulting', desc: 'Strategic planning and financial guidance for Amaranth Township entrepreneurs.' },
  { label: 'Corporate Services', href: '/services/corporate-services', desc: 'Incorporation, annual filings, and corporate compliance support.' },
  { label: 'Payroll Services', href: '/services/payroll', desc: 'Streamlined payroll processing and CRA remittances for Amaranth employers.' },
  { label: 'Financial Analysis', href: '/services/financial-analysis', desc: 'Budget management, cash flow forecasting, and performance reports.' },
]
      ...
      <div className="pt-16">
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="font-serif text-2xl font-bold text-navy">CPA Services for Amaranth Township Businesses</h2>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="bg-gold-50 border border-gold p-8">
                ...
                <p className="text-gray-600 text-sm mb-6">Get an instant quote for your Amaranth Township business.</p>
        ...
        <section className="py-16 bg-navy">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-serif text-2xl font-bold text-white mb-3">Expert CPA Services for Amaranth Township</h2>
            <p className="text-navy-100 mb-8">Virtual consultations available. Serving all of Dufferin County and beyond.</p>
