...
export const metadata: Metadata = {
  title: 'CPA Erin | Accounting & Tax Services | Adapt Accounting Services',
  ...
  openGraph: {
    title: 'CPA Services Erin, Ontario | Adapt Accounting Services',
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div>
                ...
                <h2 className="font-serif text-2xl font-bold text-navy mb-8">
                  Why Erin Businesses Choose Adapt Accounting Services
                </h2>
