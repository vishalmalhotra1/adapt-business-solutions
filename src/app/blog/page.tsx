...
const manualPosts: BlogPostEntry[] = [
  ...
  {
    id: 'professional-corporations-ontario',
    title: 'Professional Corporations in Ontario: Realtors (PREC), Doctors, Lawyers & More',
    excerpt: 'Regulator-by-regulator guide to professional corporations in Ontario. Tax benefits, share structure restrictions, naming requirements, and TOSI rules for realtors, physicians, dentists, lawyers, and ABA practitioners.',
    category: 'Professional Corporations',
  ...
  {
    id: 'side-hustle-taxes-government-employees-ontario',
    title: 'Side Hustle Taxes for Government Employees in Ontario',
    excerpt: 'Can you run a side business as a government employee? Tax obligations, conflict of interest rules, HST registration, and whether incorporation makes sense when you already have a government salary.',
    category: 'Tax Strategy',
    readTime: '7 min read',
    date: '2026-05-06',
  },
