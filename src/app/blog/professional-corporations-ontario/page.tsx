...
export const metadata: Metadata = {
  ...
  keywords: 'professional corporation Ontario, PREC Ontario realtor, doctor professional corporation Ontario, dentist incorporation Ontario, RBA incorporation Canada, ABA professional corporation Ontario, lawyer professional corporation Ontario, physiotherapist professional corporation',
...
const professions = [
  ...
  {
    title: 'Applied Behaviour Analysis (ABA) / RBAs',
    regulator: 'CRPO (College of Registered Psychotherapists), varies by designation',
    details: [
      'RBAs and RBAs providing ABA services can incorporate in Ontario.',
